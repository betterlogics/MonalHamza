...
//     <div>
//     <h1 className='my-5 bold heading '>CONTACT</h1>

//     <form>
    
// <div className='d-flex justify-content-center'>

// <div className="m-0 d-flex justify-content-start flex-column align-items-start mb-5">
...
// <input type="Text" class="boxx" />
// </div>

// <div className="m-0 d-flex justify-content-start flex-column align-items-start mb-5">
// <button class="bg-dark text-white px-4 py-2 btn me-md-2" type="button">summit</button>
// </div>
...
<div className='gg'>
        <h1 className='my-5 bold heading  py-5 px-1 mt-0'>CONTACT</h1>
